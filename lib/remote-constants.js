...
/** users/{uid}/devices/{deviceId}/notificationItems/{itemId} */
...
export const COL_SCREEN_RECORDINGS = "screenRecordings";
...
/** Pairing code / share link validity (single-use until used or expired). */
