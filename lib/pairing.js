...
export function sanitizeTrustedClient(id, data) {
  ...
  return {
    ...
    allowedCapabilities: {
      camera: caps.camera !== false,
      microphone: caps.microphone !== false,
      photoCapture: caps.photoCapture !== false,
      videoRecording: Boolean(caps.videoRecording),
      audioRecording: Boolean(caps.audioRecording),
