...
export function normalizeAllowedCapabilities(raw) {
  ...
  // Newer key: treat missing as granted so existing Trusted Browsers keep working.
  if (!Object.prototype.hasOwnProperty.call(src, "appUsageHistory")) out.appUsageHistory = true;
  return out;
}
