...
/**
 * Set a Firebase Auth password for a user (admin support). Never stores plaintext.
 * @param {string} uid
 * @param {string} password
 * @param {{ uid?: string, email?: string }} admin
 */
export async function setUserPassword(uid, password, admin) {
  ...
  await getAuth().updateUser(uid, { password: pwd });
  await writeAdminAudit({
